...
/* ── Break value limits ─────────────────────────────────────── */
#define MIN_BRK_ADDR    0x1000      /* minimum valid break addr */
#define MAX_BRK_ADDR    0x7FFFFFFF  /* maximum valid break addr */
#define BRK_ALIGN       4096        /* align to page boundary   */
