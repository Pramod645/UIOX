=======================================================================================================================
how the data from kernel space/ SOC space/FwHal Space can be copied to user space and so then what do need to update the UIOX as whole kernel and OS perspective and if need to do then you tell me which corresponding files need to be upadted and can you update source files as well?
