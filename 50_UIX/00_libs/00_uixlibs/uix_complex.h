...
typedef struct { double real; double imag; } uix_complex_t;
...
/* Parts */
UIX_INLINE double uix_creal(uix_complex_t c) { return c.real; }
UIX_INLINE double uix_cimag(uix_complex_t c) { return c.imag; }

/* Arithmetic */
UIX_INLINE uix_complex_t uix_cadd(uix_complex_t a, uix_complex_t b)
    { uix_complex_t r={a.real+b.real,a.imag+b.imag}; return r; }
UIX_INLINE uix_complex_t uix_csub(uix_complex_t a, uix_complex_t b)
    { uix_complex_t r={a.real-b.real,a.imag-b.imag}; return r; }
UIX_INLINE uix_complex_t uix_cmul(uix_complex_t a, uix_complex_t b) {
    uix_complex_t r={a.real*b.real-a.imag*b.imag,
                     a.real*b.imag+a.imag*b.real}; return r; }
UIX_INLINE uix_complex_t uix_cdiv(uix_complex_t a, uix_complex_t b) {
    double d=b.real*b.real+b.imag*b.imag;
    uix_complex_t r={(a.real*b.real+a.imag*b.imag)/d,
                     (a.imag*b.real-a.real*b.imag)/d}; return r; }

double uix_cabs (uix_complex_t c);
double uix_carg (uix_complex_t c);
uix_complex_t uix_cconj(uix_complex_t c);
uix_complex_t uix_cexp (uix_complex_t c);
uix_complex_t uix_clog (uix_complex_t c);
uix_complex_t uix_csqrt(uix_complex_t c);
