...
const char    *uix_inet_ntop   (int af, const void *src,
                                 char *dst, uix_socklen_t size);
int            uix_inet_aton   (const char *cp, uix_in_addr_s *inp);

#define UIX_INET_ADDRSTRLEN  16
#define UIX_INET6_ADDRSTRLEN 46

#define UIX_INADDR_ANY       ((uix_in_addr_t)0x00000000)
#define UIX_INADDR_BROADCAST ((uix_in_addr_t)0xffffffff)
#define UIX_INADDR_LOOPBACK  ((uix_in_addr_t)0x7f000001)
