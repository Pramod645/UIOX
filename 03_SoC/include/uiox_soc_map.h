...
#  define SOC_GIC_REDIST_BASE   0x080A0000UL   /* GIC-v3 redistributors    */
#  define SOC_GIC_ITS_BASE      0x08080000UL   /* GIC-v3 ITS               */

/* ── PL011 UART ─────────────────────────────────────────────────────── */
#  define SOC_UART0_BASE        0x09000000UL
#  define SOC_UART1_BASE        0x09040000UL
#  define SOC_UART_IRQ          33

/* ── ARM Generic Timer ──────────────────────────────────────────────── */
#  define SOC_TIMER_IRQ_PHYS    30             /* EL1 physical timer PPI   */
#  define SOC_TIMER_IRQ_VIRT    27             /* EL1 virtual timer PPI    */
#  define SOC_TIMER_IRQ_HYP     26             /* EL2 timer PPI            */

/* ── VirtIO ─────────────────────────────────────────────────────────── */
#  define SOC_VIRTIO_BASE       0x0A000000UL
#  define SOC_VIRTIO_IRQ        48

/* ── PCIe ECAM ──────────────────────────────────────────────────────── */
#  define SOC_PCIE_ECAM_BASE    0x4010000000UL
#  define SOC_PCIE_MMIO_BASE    0x10000000UL
#  define SOC_PCIE_IRQ_BASE     32
...
#  define SOC_UART_IRQ          44

#  define SOC_TIMER0_BASE       0x10011000UL
#  define SOC_TIMER0_IRQ        36
#  define SOC_TIMER1_IRQ        37

#  define SOC_IDE_BASE          0x1000A000UL
#  define SOC_IDE_IRQ           46
...
#  define SOC_CLINT_MSIP(hart)  (SOC_CLINT_BASE + 0x0000 + (hart)*4u)
#  define SOC_CLINT_MTIMECMP(h) (SOC_CLINT_BASE + 0x4000 + (h)*8u)
#  define SOC_CLINT_MTIME       (SOC_CLINT_BASE + 0xBFF8)

/* ── PLIC (Platform-Level Interrupt Controller) ─────────────────────── */
#  define SOC_PLIC_BASE         0x0C000000UL
#  define SOC_PLIC_SIZE         0x04000000UL
#  define SOC_PLIC_PRIORITY(n)  (SOC_PLIC_BASE + 4u*(n))
#  define SOC_PLIC_ENABLE(ctx)  (SOC_PLIC_BASE + 0x2000 + (ctx)*0x80)
#  define SOC_PLIC_THRESHOLD(c) (SOC_PLIC_BASE + 0x200000 + (c)*0x1000)
#  define SOC_PLIC_CLAIM(ctx)   (SOC_PLIC_BASE + 0x200004 + (ctx)*0x1000)
#  define SOC_PLIC_MAX_IRQ      127u

/* ── NS16550A UART ──────────────────────────────────────────────────── */
#  define SOC_UART0_BASE        0x10000000UL
#  define SOC_UART_IRQ          10

/* ── VirtIO ─────────────────────────────────────────────────────────── */
#  define SOC_VIRTIO_BASE       0x10001000UL
#  define SOC_VIRTIO_IRQ        1
#  define SOC_VIRTIO_STRIDE     0x1000u        /* 8 slots × 0x1000         */

#else
#  error "uiox_soc_map.h: unsupported architecture — define ARCH_ARM64, ARCH_ARM32, ARCH_X86_64, or ARCH_RISCV64"
#endif
...
#define SOC_IRQ_IS_VALID(n)     ((n) != SOC_IRQ_INVALID)
