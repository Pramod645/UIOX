/*
 * 10_BSP/10_Arch/arm32/src/irq.c
 *
 * ARM32 IRQ handler table — GIC-400 implementation.
 * Register layout identical to ARM64 GIC-400; base addresses from arch_defs.h.
 *
