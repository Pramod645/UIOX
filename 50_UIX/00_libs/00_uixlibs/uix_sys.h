...
#define SYS_CALL_ENBLE_DISABLE 0 //0: Disable, 1:Enable
...
#define TIME_SYS_CALL
#define NETWORK_SYS_CALL

/*******  FILE_SYSTEM enables the interfaces only for files related system calls ******/
#ifdef FILE_SYSTEM
...
/*****  PROCESS_CONTROL(Memory Managment and synchronizations) system calls only enabled *******/
...
/*****  TIME  system calls only enabled *******/
#ifdef TIME_SYS_CALL
/******************* 1.             ******************************/
...
/*****  Network  system calls only enabled *******/
#ifdef NETWORK_SYS_CALL
/******************* 9.                ******************************/
