...
/*
 * uiox_boot_handoff.h - ELF loader + kernel handoff.
 */
...
typedef struct {
    uboot_u32_t     magic;          /* UIOX_BOOT_MAGIC         */
    uboot_u32_t     version;        /* 1                       */
    uboot_u32_t     arch;
...
/* arch-specific final jump (never returns) */
void uboot_jump_to_kernel(uboot_u64_t entry,
                            uboot_u64_t args_phys);

/* needed by uiox_boot_hw.h inline */
typedef uboot_uart_type_t uboot_uart_type_t;
