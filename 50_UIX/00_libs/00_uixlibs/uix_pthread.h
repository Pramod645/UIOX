...
#ifndef UIX_PTHREAD_H
#define UIX_PTHREAD_H

#include "uix_types.h"
#include "uix_time.h"

typedef uix_uint64_t uix_pthread_t;
typedef uix_uint64_t uix_pthread_mutex_t;
typedef uix_uint64_t uix_pthread_cond_t;
...
#define UIX_PTHREAD_MUTEX_INITIALIZER 0
#define UIX_PTHREAD_COND_INITIALIZER  0
#define UIX_PTHREAD_CREATE_JOINABLE   0
...
int            uix_pthread_join        (uix_pthread_t t, void **retval);
int            uix_pthread_detach      (uix_pthread_t t);
void           uix_pthread_exit        (void *retval) __attribute__((noreturn));
uix_pthread_t  uix_pthread_self        (void);
...
void          *uix_pthread_getspecific   (uix_pthread_key_t k);
