...
typedef uix_uint32_t uix_wctype_t;
typedef uix_uint32_t uix_wctrans_t;

int uix_iswalpha (uix_wint_t c);
int uix_iswdigit (uix_wint_t c);
...
uix_wint_t   uix_towupper (uix_wint_t c);
uix_wint_t   uix_towlower (uix_wint_t c);
uix_wctype_t uix_wctype   (const char *name);
int          uix_iswctype (uix_wint_t c, uix_wctype_t type);
