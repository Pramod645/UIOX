/**
 * @file  uiox_fw_hw.c
 * @brief UIOX Firmware — HW HAL ops registration and wrappers.
 * @date  2026-06-21
 */
 ...
 static const uiox_fw_hw_ops_t *s_ops  = NULL;
 static uiox_fw_platform_t     *s_plat = NULL;
 ...
 void uiox_fw_hw_barrier(void)
{
 ...
 const uiox_fw_hw_ops_t *uiox_fw_hw_ops(void)     { return s_ops;  }
 uiox_fw_platform_t     *uiox_fw_hw_platform(void) { return s_plat; }
 
 uiox_fw_err_t uiox_fw_hw_init(void)
 {
     if (!s_ops || !s_ops->init) return UIOX_FW_ERR_NODEV;
